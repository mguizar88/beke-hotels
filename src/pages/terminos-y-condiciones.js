        ...
        <Layout>
            <div className="bg-gradient-to-br from-beke to-gray-900">
                <div className="max-w-screen-md mx-auto py-12 px-4">
                    <h1 className="text-center text-white text-2xl sm:text-6xl mb-12">Términos y condiciones</h1>
                    <div className="shadow-lg rounded-xl mb-16 p-4 bg-gray-900 text-white">
                    ...
                    <div className="shadow-lg rounded-xl my-16 p-4 bg-gray-900 text-white">
                        <h2>Tarifa Flex:</h2>
                        <p>
