...
const PierPage = ({data, path}) => {
    ...
    return (
        <>
            <Helmet>
                <script src='https://www.thehotelsnetwork.com/js/hotel_price_widget.js?hotel_id=1130925&property_id=1033475&account_key=13F4DBC854C4C39DFCBD774AF370011B' async></script>
            </Helmet>
            <Layout path={path}>
